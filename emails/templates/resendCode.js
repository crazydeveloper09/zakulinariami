export const resendCodeTemplate = ({code}) => `
<!DOCTYPE html>
<html lang="pl">
<head>
  <meta charset="UTF-8" />
...
<td style="padding:32px;">
  ...
  <p style="font-family:'DM Sans', Arial; font-size:15px;">
    Oto Twój nowy kod do potwierdzenia konta:
  </p>

  <div style="margin:24px 0; padding:16px; background:#F5F6F4; text-align:center;
    font-family:'DM Sans', Arial; font-size:24px; font-weight:600; letter-spacing:4px;">
    ${code}
  </div>
